    ...
    <ul>
      <li>
        <el-radio-group v-model="choose" class="ml-4" @change="change">
          <el-radio label="1" size="large">发布的</el-radio>
          <el-radio label="2" size="large">平台待审核</el-radio>
          <el-radio label="3" size="large">平台审核不通过</el-radio>
        </el-radio-group>
      </li>
      <li class="itemsList"
              ...
              <el-col :span="2" :offset="3">
                <div v-if="choose === '1'">
                  <ul>
                    ...
                    <li>
                      <el-button class="margin_top_25" type="success" @click="remove(item.goodsId)"> 删除</el-button>
                    </li>

                    <li>
                      <el-button class="margin_top_25" type="success" @click="off(item.goodsId)"> 下架</el-button>
                    </li>
                  </ul>
                </div>
              </el-col>
...
import {deleteGoods, listCategory, offGoods, updateGoodsInfo} from "@/api/goods";
